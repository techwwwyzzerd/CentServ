...
config.vm.define "repo" do |repo|
  repo.vm.box = "techwwwyzzerd/pracrepo"
#  repo.vm.hostname = "repo.test.example.com"
  repo.vm.network "private_network", ip: "192.168.1.50"
...
config.vm.define "ipa" do |ipa|
  ...
  ipa.vm.network "private_network", ip: "192.168.1.51"
...
config.vm.define "system1" do |system1|
  system1.vm.box = "techwwwyzzerd/pracenvs"
#  system1.vm.hostname = "system1.test.example.com"
  system1.vm.network "private_network", ip: "192.168.1.52"
  system1.vm.network "private_network", ip: "192.168.1.61"
  system1.vm.network "private_network", ip: "192.168.1.62"
...
config.vm.define "system2" do |system2|
  system2.vm.box = "techwwwyzzerd/pracenvs"
#  system2.vm.hostname = "system2.test.example.com"
  system2.vm.network "private_network", ip: "192.168.1.53"
  system2.vm.network "private_network", ip: "192.168.1.63"
  system2.vm.network "private_network", ip: "192.168.1.64"
